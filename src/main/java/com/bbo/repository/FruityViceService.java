...
public interface FruityViceService {
    ...
    class FruityViceFallback implements FallbackHandler<FruityVice> {
        ...
        public static final FruityVice EMPTY_FRUITY_VICE = FruityVice.of("empty", FruityVice.Nutritions.of(0.0, 0.0));

        @Override
        public FruityVice handle(ExecutionContext executionContext) {
